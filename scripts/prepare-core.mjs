...
// Typed as plain strings on purpose: 'as const' would narrow these to literals
// and make an ordinary comparison against them a type error.
export interface BuildInfo {
  playgroundCommit: string;
  coreRef: string;
}
